...
function siteorigin_panels_render( $post_id = false, $enqueue_css = true, $panels_data = false ) {
	...
	foreach ( $grids as $gi => $cells ) {
		...
		//Themes can add their container - Added by Sunil
		apply_filters( 'siteorigin_panels_row_container_start',$panels_data['grids'][$gi], $grid_attributes );
		...
		//Themes can add their container - Added by Sunil
		apply_filters( 'siteorigin_panels_row_container_end',$panels_data['grids'][$gi], $grid_attributes );
		echo '</div>';
