<div class="social-icons clearfix social-media-button-container">
	<?php foreach( $networks as $network ) :
		...
		<span><a  data-rel="tooltip" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" data-title="<?php echo sanitize_html_class( $network['name'] );?>"<?php foreach($button_attributes as $name => $val) echo $name . '="' . $val . '" ' ?>>
