...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<p class="form-row form-row-wide" id="calc_shipping_country_field">
			<select name="calc_shipping_country" class="form-control" id="calc_shipping_country" class="country_to_state" rel="calc_shipping_state">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="btn-primary border-radius"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
