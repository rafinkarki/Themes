<?php
/*
 * Template Name: Grid Three Columns Portfolio
 *
 */
...
<section class="<?php echo $s_color;?> clearfix">    
    <div id="second" class="container bf">                
        ...
        <ul class="filter">        
            ...
            <?php if (have_posts()) : ?>
                <ul id="grid-three-col-portfolio" class="items row-fluid">  
                ...
                <li class="<?php echo $filters; ?>">
                    <div class="bf-single-item wow fadeIn">
                        <?php $thumbnail = get_post_thumbnail_id($post->ID);                        
                           ...
                           $n_img = aq_resize( $img_url[0], $width = 390, $height = 280, $crop = true, $single = true, $upscale = true ); 
