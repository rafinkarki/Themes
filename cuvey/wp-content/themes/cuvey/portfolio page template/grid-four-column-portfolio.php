<?php
/*
 * Template Name: Grid Four Columns Portfolio
 *
 */
...
<section class="<?php echo $s_color;?> clearfix">    
    <div id="second" class="container bf">                
        ...
        <ul class="filter">        
            ...
            <?php if (have_posts()) : ?>
                <ul id="grid-four-col-portfolio" class="items row-fluid"> 
                ...
                <li class="<?php echo $filters; ?>">
                    <div class="bf-single-item wow fadeIn">
                        <?php $thumbnail = get_post_thumbnail_id($post->ID);                        
                           ...
                           $n_img = aq_resize( $img_url[0], $width = 293, $height = 221, $crop = true, $single = true, $upscale = true ); 
