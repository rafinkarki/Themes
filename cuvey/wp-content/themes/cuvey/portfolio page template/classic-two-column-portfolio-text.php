<?php
/*
 * Template Name: Classic Two Portfolio with Text
 *
 */
...
<section class="<?php echo $s_color;?> clearfix">    
    <div id="second" class="container bf">                
        ...
        <ul class="filter">        
            ...
            <?php if (have_posts()) : ?>
                <ul id="two-col-portfolio" class="items with-text row-fluid">
                ...
                <li class="<?php echo $filters; ?>">
                    <div class="bf-single-item wow fadeIn">
                        <?php $thumbnail = get_post_thumbnail_id($post->ID);                        
                           ...
                           $n_img = aq_resize( $img_url[0], $width = 555, $height = 454, $crop = true, $single = true, $upscale = true );
            ...
            <div class="clearfix portfolio-button text-center <?php echo $b_color;?>">
