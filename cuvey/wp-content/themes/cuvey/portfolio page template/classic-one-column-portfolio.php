<?php
/*
 * Template Name: Classic One Portfolio without Text
 *
 */
...
<section class="<?php echo $s_color;?> clearfix">    
        <div id="second" class="container bf">                
            ...
            <ul class="filter">        
                ...
                <?php if (have_posts()) : ?>
                    <ul id="one-col-portfolio" class="items row-fluid"> 
                    ...
                    <li class="<?php echo $filters; ?>">
                        <div class="bf-single-item wow fadeIn">
                            <?php $thumbnail = get_post_thumbnail_id($post->ID);                        
                               ...
                               $n_img = aq_resize( $img_url[0], $width = 1140, $height = 628, $crop = true, $single = true, $upscale = true ); 
