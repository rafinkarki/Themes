<?php
/*
 * Template Name: Gallery Fullwidth Portfolio
 *
 */
...
<section class="<?php echo $s_color;?> clearfix">    
    <div id="second" class="bf fullwidth row">                
        ...
        <ul class="filter">        
            ...
            <?php if (have_posts()) : ?>
                <ul id="grid-five-col-portfolio" class="items">
                ...
                <li class="<?php echo $filters; ?>">
                    <div class="bf-single-item wow fadeIn">
                        <?php $thumbnail = get_post_thumbnail_id($post->ID);                        
                           ...
                           $n_img = aq_resize( $img_url[0], $width = 276, $height = 324, $crop = true, $single = true, $upscale = true ); 
