<?php
/*
 * Template Name: Classic Three Portfolio without Text
 *
 */
                ...
                <li class="<?php echo $filters; ?>">
                    <div class="bf-single-item wow fadeIn">
                        <?php $thumbnail = get_post_thumbnail_id($post->ID);                        
                           ...
                           $n_img = aq_resize( $img_url[0], $width = 360, $height = 259, $crop = true, $single = true, $upscale = true );
                        ...
                        <div class="caption">
                            <div class="cap-in">                                    
                                ...
                                <a href="<?php echo esc_url($n_img);?>" rel="prettyPhoto" title=""><span class="bubble border-radius"><i class="fa fa-search"></i></span></a>
                            </div>
                        </div>
                    </div>
                </li>
