<?php
/*
 * Template Name: Grid Two Columns Portfolio
 *
 */
...
<section class="<?php echo $s_color;?> clearfix">    
    <div id="second" class="container bf">                
        ...
        <ul class="filter">        
            ...
            <?php if (have_posts()) : ?>
                <ul id="grid-two-col-portfolio" class="items row-fluid">  
                ...
                <li class="<?php echo $filters; ?>">
                    <div class="bf-single-item wow fadeIn">
                        <?php $thumbnail = get_post_thumbnail_id($post->ID);                        
                           ...
                           $n_img = aq_resize( $img_url[0], $width = 585, $height = 478, $crop = true, $single = true, $upscale = true ); 
